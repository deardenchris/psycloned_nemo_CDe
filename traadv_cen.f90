  ...
  SUBROUTINE tra_adv_cen(kt, kit000, cdtype, pun, pvn, pwn, ptn, pta, kjpt, kn_cen_h, kn_cen_v)
    ...
    DO jn = 1, kjpt
      ...
      CASE (4)
        ...
        !$ACC END KERNELS
      CASE DEFAULT
        CALL profile_psy_data2 % PreStart('tra_adv_cen', 'r2', 0, 0)
      ...
      CASE (2)
        ...
        !$ACC END KERNELS
      CASE (4)
        CALL profile_psy_data3 % PreStart('tra_adv_cen', 'r3', 0, 0)
      ...
      END DO
      !$ACC END KERNELS
      CALL profile_psy_data4 % PreStart('tra_adv_cen', 'r4', 0, 0)
      IF (l_trd) THEN
