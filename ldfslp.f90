MODULE ldfslp
  ...
  SUBROUTINE ldf_slp(kt, prd, pn2)
    ...
    END DO
    !$ACC END KERNELS
    CALL profile_psy_data1 % PreStart('ldf_slp', 'r1', 0, 0)
    ...
    END DO
    !$ACC END KERNELS
    CALL profile_psy_data2 % PreStart('ldf_slp', 'r2', 0, 0)
    ...
    END DO
    !$ACC END KERNELS
    CALL profile_psy_data3 % PreStart('ldf_slp', 'r3', 0, 0)
    ...
    DO jk = 2, jpkm1
      ...
      !$ACC END KERNELS
    END DO
    CALL profile_psy_data4 % PreStart('ldf_slp', 'r4', 0, 0)
  ...
  SUBROUTINE ldf_slp_triad(kt)
    ...
    wslp2(:, :, 1) = 0._wp
    !$ACC END KERNELS
    CALL profile_psy_data2 % PreStart('ldf_slp_triad', 'r2', 0, 0)
  ...
  SUBROUTINE ldf_slp_mxl(prd, pn2, p_gru, p_grv, p_dzr)
    ...
    END DO
    !$ACC END KERNELS
    CALL profile_psy_data0 % PreStart('ldf_slp_mxl', 'r0', 0, 0)
